export default function Home() {
  return (
    <body className="flex flex-col min-h-screen subpixel-antialiased">
        ...
        <section className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          <div className="flex flex-col gap-8 sm:gap-12 lg:gap-16">
            ...
            <div className="w-full space-y-4 divide-y divide-gray-200 mx-auto">
              ...
              <table className="pr-12 w-full">
                <tbody className="bg-white">
                  <tr className="even:bg-gray-50">
                    <td className="whitespace-nowrap px-4 h-12 items-center text-gray-800 font-inter text-sm sm:w-48">
                      Coverage
                    </td>
                    <td className="flex gap-x-1.5 items-center whitespace-nowrap px-4 h-12 text-green-500 font-medium font-inter text-sm">
                      Valid
                      <svg
                  ...
                  <tr className="even:bg-gray-50">
                    <td className="whitespace-nowrap px-4 h-12 items-center text-gray-800 font-inter text-sm">
                      Expiry
                    </td>
                    <td className="whitespace-nowrap px-4 h-12 items-center text-gray-800 font-inter text-sm">
                  ...
                  <tr className="even:bg-gray-50">
                    ...
                    <td className="flex gap-x-3 whitespace-nowrap px-4 h-12 items-center text-gray-800 font-inter text-sm">
                      Apple
                    </td>
                  </tr>
                  <tr className="even:bg-gray-50">
                  ...
                  <tr className="even:bg-gray-50">
                    ...
                    <td className="flex gap-x-2 whitespace-nowrap px-4 h-12 items-center text-gray-800 font-inter text-sm">
                      40433-22441
                    </td>
                  </tr>
                </tbody>
      ...
      <footer>
        <div className="mx-auto max-w-7xl w-full h-auto"></div>
        <div className="bg-gray-900 mx-auto px-6 pb-8 pt-16 sm:pt-16 lg:px-8 lg:pt-20">
          <div className="space-y-8 max-w-7xl mx-auto">
            <div className="flex pb-1 sm:justify-center">
              <a
                href="#"
                className="p-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-600 -ml-2 sm:ml-0"
              >
                <img className="h-6 sm:mx-auto" src="logorev.svg" alt="DISMO" />
              </a>
            </div>
            <nav className="-mb-6 columns-2 sm:flex sm:justify-center sm:space-x-8">
              <div className="pb-6">
                <a
                  href="#"
                  className="text-sm p-2 -ml-2 sm:ml-0 text-gray-300 font-semibold hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-600"
                >
                  About DISMO
                </a>
              </div>
